...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'perfiles_conocimiento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('nivel', self.gf('django.db.models.fields.CharField')(default='B\xc3\xa1sico', max_length=50)),
        ))
        db.send_create_signal(u'perfiles', ['Conocimiento'])

        # Adding model 'Profesion'
        db.create_table(u'perfiles_profesion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'perfiles', ['Profesion'])

        # Adding field 'Perfil.info'
        db.add_column(u'perfiles_perfil', 'info',
                      self.gf('django.db.models.fields.TextField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Perfil.foto'
        db.add_column(u'perfiles_perfil', 'foto',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Perfil.foto_social'
        db.add_column(u'perfiles_perfil', 'foto_social',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Perfil.profesion'
        db.add_column(u'perfiles_perfil', 'profesion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['perfiles.Profesion'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Perfil.google'
        db.add_column(u'perfiles_perfil', 'google',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Perfil.web'
        db.add_column(u'perfiles_perfil', 'web',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field conocimiento on 'Perfil'
        m2m_table_name = db.shorten_name(u'perfiles_perfil_conocimiento')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('perfil', models.ForeignKey(orm[u'perfiles.perfil'], null=False)),
            ('conocimiento', models.ForeignKey(orm[u'perfiles.conocimiento'], null=False))
        ))
        db.create_unique(m2m_table_name, ['perfil_id', 'conocimiento_id'])


    def backwards(self, orm):
        # Deleting model 'Conocimiento'
        db.delete_table(u'perfiles_conocimiento')

        # Deleting model 'Profesion'
        db.delete_table(u'perfiles_profesion')

        # Deleting field 'Perfil.info'
        db.delete_column(u'perfiles_perfil', 'info')

        # Deleting field 'Perfil.foto'
        db.delete_column(u'perfiles_perfil', 'foto')

        # Deleting field 'Perfil.foto_social'
        db.delete_column(u'perfiles_perfil', 'foto_social')

        # Deleting field 'Perfil.profesion'
        db.delete_column(u'perfiles_perfil', 'profesion_id')

        # Deleting field 'Perfil.google'
        db.delete_column(u'perfiles_perfil', 'google')
        ...
        # Deleting field 'Perfil.web'
        db.delete_column(u'perfiles_perfil', 'web')

        # Removing M2M table for field conocimiento on 'Perfil'
        db.delete_table(db.shorten_name(u'perfiles_perfil_conocimiento'))
