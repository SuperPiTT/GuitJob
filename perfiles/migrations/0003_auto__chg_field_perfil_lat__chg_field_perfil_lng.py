...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Perfil.lat'
        db.alter_column(u'perfiles_perfil', 'lat', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=22, decimal_places=18))

        # Changing field 'Perfil.lng'
        db.alter_column(u'perfiles_perfil', 'lng', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=22, decimal_places=18))

    def backwards(self, orm):

        # Changing field 'Perfil.lat'
        db.alter_column(u'perfiles_perfil', 'lat', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=9))

        # Changing field 'Perfil.lng'
        db.alter_column(u'perfiles_perfil', 'lng', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=9))
