...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conocimiento.perfil'
        db.add_column(u'perfiles_conocimiento', 'perfil',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['perfiles.Perfil']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Conocimiento.perfil'
        db.delete_column(u'perfiles_conocimiento', 'perfil_id')
