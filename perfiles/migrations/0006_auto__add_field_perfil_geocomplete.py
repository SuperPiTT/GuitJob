...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Perfil.geocomplete'
        db.add_column(u'perfiles_perfil', 'geocomplete',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Perfil.geocomplete'
        db.delete_column(u'perfiles_perfil', 'geocomplete')
