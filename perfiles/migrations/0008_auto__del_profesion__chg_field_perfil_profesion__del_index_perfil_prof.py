...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Perfil.profesion' to match new field type.
        db.rename_column(u'perfiles_perfil', 'profesion_id', 'profesion')
        # Changing field 'Perfil.profesion'
        db.alter_column(u'perfiles_perfil', 'profesion', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
        # Removing index on 'Perfil', fields ['profesion']
        db.delete_index(u'perfiles_perfil', ['profesion_id'])


    def backwards(self, orm):
        # Adding index on 'Perfil', fields ['profesion']
        db.create_index(u'perfiles_perfil', ['profesion_id'])
        ...
        # Renaming column for 'Perfil.profesion' to match new field type.
        db.rename_column(u'perfiles_perfil', 'profesion', 'profesion_id')
        # Changing field 'Perfil.profesion'
        db.alter_column(u'perfiles_perfil', 'profesion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['perfiles.Profesion'], null=True))
    ...
    models = {
        ...
        u'perfiles.conocimiento': {
            ...
            'perfil': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'techs'", 'to': u"orm['perfiles.Perfil']"})
        },
        u'perfiles.perfil': {
            ...
            'geocomplete': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
